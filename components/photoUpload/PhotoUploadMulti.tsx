  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <label
          htmlFor="fileInput"
          className="mt-3 inline-block cursor-pointer rounded-md bg-blue-500 px-4 py-2 text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          Izberite slike
        </label>
