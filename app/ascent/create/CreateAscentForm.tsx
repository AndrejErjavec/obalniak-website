...
export default function CreateAscentPage({ userId }: { userId: string }) {
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <section className="flex flex-col gap-3 md:w-1/3">
            ...
            <div>
              ...
              <Input type="number" id="length" name="length" placeholder="dolžina smeri v metrih" />
            </div>
            ...
            <UserSelect userId={userId} setUsers={setCoClimbers} />
          </section>
